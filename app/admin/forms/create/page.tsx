...
import { Plus, Trash2, GripVertical, MessageCircle, FileText, Settings, List } from 'lucide-react'
...
export default function CreateFormPage() {
  ...
  // Check WhatsApp status and load pejabat list
  useEffect(() => {
    checkWhatsAppStatus()
    fetchPejabatList()
  }, [])
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Buat Form Baru</h1>
        <p className="text-gray-600">
          Buat form pengajuan surat dengan field custom sesuai kebutuhan
        </p>
      </div>
          ...
          <Card>
            ...
            <CardBody className="space-y-4">
              ...
              <RichTextEditor
                ...
                placeholder="Ketik template dokumen di sini. Contoh:

Pontianak, {{tanggal_surat}}
